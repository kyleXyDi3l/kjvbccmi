        ...
        <div className="flex-1 py-6 px-4">
            ...
            {navigationItems.map((item) => (
              <button
                ...
                className={`group relative w-full flex items-center gap-3 px-4 py-3 text-xs font-extrabold rounded-xl transition-all duration-200 ${
                  activeTab === item.id
                    ? `bg-gradient-to-r from-${item.color}-600 to-${item.color === "indigo" ? "purple" : item.color === "amber" ? "orange" : "teal"}-600 text-white shadow-lg shadow-${item.color}-500/25`
          ...
          <div className="absolute bottom-6 left-4 right-4">
            <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl p-3">
              ...
              >
                Full administrative control over all church platforms.
              </p>
