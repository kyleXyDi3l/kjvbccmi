            ...
            {navigationItems.map((item) => (
              <button
                ...
                className={`group relative w-full flex items-center gap-3 px-4 py-3 text-xs font-extrabold rounded-xl transition-all duration-200 ${
                  activeTab === item.id
                    ? `bg-gradient-to-r from-${item.color}-600 to-${item.color === "amber" ? "orange" : "teal"}-600 text-white shadow-lg shadow-${item.color}-500/25`
              ...
              >
                ...
                {item.id === "forReview" && stats.pendingReviews > 0 && (
